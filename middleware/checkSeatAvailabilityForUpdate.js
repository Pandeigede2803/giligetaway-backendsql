    ...
    try {
        ...
        if (payment_status) {
            ...
            const validTransitions = {
                'invoiced': ['paid', 'abandoned','cancelled','refund_50', 'refund_100',],
                'unpaid': ['paid', 'abandoned', 'cancelled'],
                'pending': ['paid', 'abandoned', 'cancelled'],
                'paid': ['refund_50', 'refund_100', 'cancelled', 'abandoned','pending'],
