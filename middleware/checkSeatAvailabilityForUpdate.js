...
const validatePaymentUpdate = async (req, res, next) => {
    ...
    try {
        ...
        if (payment_method) {
            const validPaymentMethods = ['credit_card', 'bank_transfer', 'cash', 'paypal', 'cash_bali',"prepaid doku","prepaid card", 'cash_gili_trawangan', 'cash_gili_gede', 'credit_card_doku_edc'];
